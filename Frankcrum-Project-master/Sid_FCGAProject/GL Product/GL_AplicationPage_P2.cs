...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.TxtLicenseType' at 100;31.", repo.ApplicationUnderTest.TxtLicenseTypeInfo, new RecordItemIndex(0));
            repo.ApplicationUnderTest.TxtLicenseType.Click("100;31");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$GL_LicenseType' with focus on 'ApplicationUnderTest.TxtLicenseType'.", repo.ApplicationUnderTest.TxtLicenseTypeInfo, new RecordItemIndex(1));
            repo.ApplicationUnderTest.TxtLicenseType.PressKeys(GL_LicenseType);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.TxtLicenseNumber' at 24;15.", repo.ApplicationUnderTest.TxtLicenseNumberInfo, new RecordItemIndex(2));
            repo.ApplicationUnderTest.TxtLicenseNumber.Click("24;15");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$GL_LicenseNo' with focus on 'ApplicationUnderTest.TxtLicenseNumber'.", repo.ApplicationUnderTest.TxtLicenseNumberInfo, new RecordItemIndex(3));
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$GL_IndustrialPercent' with focus on 'ApplicationUnderTest.TxtIndustrial'.", repo.ApplicationUnderTest.TxtIndustrialInfo, new RecordItemIndex(6));
            repo.ApplicationUnderTest.TxtIndustrial.PressKeys(GL_IndustrialPercent);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.TxtNewConstruction' at Center.", repo.ApplicationUnderTest.TxtNewConstructionInfo, new RecordItemIndex(7));
            repo.ApplicationUnderTest.TxtNewConstruction.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$GL_NewConstructionPercent' with focus on 'ApplicationUnderTest.TxtNewConstruction'.", repo.ApplicationUnderTest.TxtNewConstructionInfo, new RecordItemIndex(8));
            repo.ApplicationUnderTest.TxtNewConstruction.PressKeys(GL_NewConstructionPercent);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.TxtCommercial' at Center.", repo.ApplicationUnderTest.TxtCommercialInfo, new RecordItemIndex(9));
            repo.ApplicationUnderTest.TxtCommercial.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$GL_CommercialPercent' with focus on 'ApplicationUnderTest.TxtCommercial'.", repo.ApplicationUnderTest.TxtCommercialInfo, new RecordItemIndex(10));
            repo.ApplicationUnderTest.TxtCommercial.PressKeys(GL_CommercialPercent);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.TxtResidential' at Center.", repo.ApplicationUnderTest.TxtResidentialInfo, new RecordItemIndex(11));
            repo.ApplicationUnderTest.TxtResidential.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$GL_ResidentialPercent' with focus on 'ApplicationUnderTest.TxtResidential'.", repo.ApplicationUnderTest.TxtResidentialInfo, new RecordItemIndex(12));
            repo.ApplicationUnderTest.TxtResidential.PressKeys(GL_ResidentialPercent);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.TxtRoomAdditions' at Center.", repo.ApplicationUnderTest.TxtRoomAdditionsInfo, new RecordItemIndex(13));
            repo.ApplicationUnderTest.TxtRoomAdditions.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$GL_RoomAdditionsPercent' with focus on 'ApplicationUnderTest.TxtRoomAdditions'.", repo.ApplicationUnderTest.TxtRoomAdditionsInfo, new RecordItemIndex(14));
            repo.ApplicationUnderTest.TxtRoomAdditions.PressKeys(GL_RoomAdditionsPercent);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.TxtRemodeling' at Center.", repo.ApplicationUnderTest.TxtRemodelingInfo, new RecordItemIndex(15));
            repo.ApplicationUnderTest.TxtRemodeling.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$GL_RemodelingPercent' with focus on 'ApplicationUnderTest.TxtRemodeling'.", repo.ApplicationUnderTest.TxtRemodelingInfo, new RecordItemIndex(16));
            repo.ApplicationUnderTest.TxtRemodeling.PressKeys(GL_RemodelingPercent);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.TxtRepaireOrService' at Center.", repo.ApplicationUnderTest.TxtRepaireOrServiceInfo, new RecordItemIndex(17));
            repo.ApplicationUnderTest.TxtRepaireOrService.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$GL_RepairOrServicePercent' with focus on 'ApplicationUnderTest.TxtRepaireOrService'.", repo.ApplicationUnderTest.TxtRepaireOrServiceInfo, new RecordItemIndex(18));
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$GL_WorkSubContractedComment' with focus on 'ApplicationUnderTest.TxtWorkSubcontracted'.", repo.ApplicationUnderTest.TxtWorkSubcontractedInfo, new RecordItemIndex(21));
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$GL_ExpectedGross' with focus on 'ApplicationUnderTest.TxtExpectedGrossReceipts'.", repo.ApplicationUnderTest.TxtExpectedGrossReceiptsInfo, new RecordItemIndex(25));
            repo.ApplicationUnderTest.TxtExpectedGrossReceipts.PressKeys(GL_ExpectedGross);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.TxtAmountInsuredSubcon' at Center.", repo.ApplicationUnderTest.TxtAmountInsuredSubconInfo, new RecordItemIndex(26));
            repo.ApplicationUnderTest.TxtAmountInsuredSubcon.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$GL_AmountInsSubContractor' with focus on 'ApplicationUnderTest.TxtAmountInsuredSubcon'.", repo.ApplicationUnderTest.TxtAmountInsuredSubconInfo, new RecordItemIndex(27));
            repo.ApplicationUnderTest.TxtAmountInsuredSubcon.PressKeys(GL_AmountInsSubContractor);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.TxtAmountUninsuredSubcon' at Center.", repo.ApplicationUnderTest.TxtAmountUninsuredSubconInfo, new RecordItemIndex(28));
            repo.ApplicationUnderTest.TxtAmountUninsuredSubcon.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$GL_AmtUninsuredSubContractor' with focus on 'ApplicationUnderTest.TxtAmountUninsuredSubcon'.", repo.ApplicationUnderTest.TxtAmountUninsuredSubconInfo, new RecordItemIndex(29));
            repo.ApplicationUnderTest.TxtAmountUninsuredSubcon.PressKeys(GL_AmtUninsuredSubContractor);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.TxtPartnersFullTimeEmp' at Center.", repo.ApplicationUnderTest.TxtPartnersFullTimeEmpInfo, new RecordItemIndex(30));
            repo.ApplicationUnderTest.TxtPartnersFullTimeEmp.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$GL_PartnersFullTimeEmp' with focus on 'ApplicationUnderTest.TxtPartnersFullTimeEmp'.", repo.ApplicationUnderTest.TxtPartnersFullTimeEmpInfo, new RecordItemIndex(31));
            repo.ApplicationUnderTest.TxtPartnersFullTimeEmp.PressKeys(GL_PartnersFullTimeEmp);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.TxtPartnersPartTimeEmp' at Center.", repo.ApplicationUnderTest.TxtPartnersPartTimeEmpInfo, new RecordItemIndex(32));
            repo.ApplicationUnderTest.TxtPartnersPartTimeEmp.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$GL_PartnersPartTimeEmp' with focus on 'ApplicationUnderTest.TxtPartnersPartTimeEmp'.", repo.ApplicationUnderTest.TxtPartnersPartTimeEmpInfo, new RecordItemIndex(33));
