...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Wait", "Waiting 15s to exist. Associated repository item: 'ApplicationUnderTest.LblPremium'", repo.ApplicationUnderTest.LblPremiumInfo, new ActionTimeout(15000), new RecordItemIndex(13));
