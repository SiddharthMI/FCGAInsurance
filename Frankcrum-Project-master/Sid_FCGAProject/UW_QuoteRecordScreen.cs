...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.Txtsearch' at Center.", repo.ApplicationUnderTest.TxtsearchInfo, new RecordItemIndex(0));
            repo.ApplicationUnderTest.Txtsearch.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$UW_InsuredName' with focus on 'ApplicationUnderTest.Txtsearch'.", repo.ApplicationUnderTest.TxtsearchInfo, new RecordItemIndex(1));
            repo.ApplicationUnderTest.Txtsearch.PressKeys(UW_InsuredName);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '{Return}' with focus on 'ApplicationUnderTest.Txtsearch'.", repo.ApplicationUnderTest.TxtsearchInfo, new RecordItemIndex(2));
