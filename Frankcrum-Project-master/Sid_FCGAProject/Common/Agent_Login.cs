...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.SelectAgencyContact' at Center.", repo.ApplicationUnderTest.SelectAgencyContactInfo, new RecordItemIndex(11));
            repo.ApplicationUnderTest.SelectAgencyContact.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$AgentName' with focus on 'ApplicationUnderTest.Search'.", repo.ApplicationUnderTest.SearchInfo, new RecordItemIndex(12));
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.BtnContinue' at Center.", repo.ApplicationUnderTest.BtnContinueInfo, new RecordItemIndex(14));
